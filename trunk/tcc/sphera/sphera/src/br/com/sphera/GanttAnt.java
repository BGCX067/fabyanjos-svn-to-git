...
import org.jfree.ui.RefineryUtilities;
 public class GanttAnt extends ApplicationFrame{  
    
      public GanttAnt(String s){  
          super(s);  
      ...
      {  
          ...
          Task task = new Task("Escrever proposta", date(1, 3, 2001), date(5, 3, 2001));  
          task.setPercentComplete(1.0D);  
          taskseries.add(task);  
          Task task1 = new Task("Obter aprovação", date(9, 3, 2001), date(9, 3, 2001));  
          task1.setPercentComplete(1.0D);  
          taskseries.add(task1);  
          Task task2 = new Task("Analise de requerimentos", date(10, 3, 2001), date(5, 4, 2001));  
          Task task3 = new Task("Requirementos 1", date(10, 3, 2001), date(25, 3, 2001));  
          task3.setPercentComplete(1.0D);  
          Task task4 = new Task("Requirementos 2", date(1, 4, 2001), date(5, 4, 2001));  
          task4.setPercentComplete(1.0D);  
          task2.addSubtask(task3);  
          task2.addSubtask(task4);  
          taskseries.add(task2);  
          Task task5 = new Task("Fase Desenho", date(6, 4, 2001), date(30, 4, 2001));  
          Task task6 = new Task("Desenho 1", date(6, 4, 2001), date(10, 4, 2001));  
          task6.setPercentComplete(1.0D);  
          Task task7 = new Task("Desenho 2", date(15, 4, 2001), date(20, 4, 2001));  
          task7.setPercentComplete(1.0D);  
          Task task8 = new Task("Desenho 3", date(23, 4, 2001), date(30, 4, 2001));  
          task8.setPercentComplete(0.5D);  
          task5.addSubtask(task6);  
          task6.setDescription("teste");  
          ...
          Task task10 = new Task("Implementação", date(3, 5, 2001), date(31, 6, 2001));  
          task10.setPercentComplete(0.59999999999999998D);  
          taskseries.add(task10);  
          Task task11 = new Task("Revisão Design", date(1, 7, 2001), date(8, 7, 2001));  
      ...
      {  
          GanttAnt ganttdemo2 = new GanttAnt("Gantt Chart Demo 2");  
          ganttdemo2. pack();  
